...
ListNotificationResponse _$ListNotificationResponseFromJson(
    ...
    ListNotificationResponse(
      ...
      data: (json['data'] as List<dynamic>?)
              ?.map((e) =>
                  ItemNotificationData.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
    );
...
ItemNotificationData _$ItemNotificationDataFromJson(
        Map<String, dynamic> json) =>
    ItemNotificationData(
      title: json['title'] as String?,
      body: json['body'] as String?,
      categoryNotification: json['categoryNotification'] as String?,
...
Map<String, dynamic> _$ItemNotificationDataToJson(
        ItemNotificationData instance) =>
    <String, dynamic>{
      'title': instance.title,
      'body': instance.body,
      'categoryNotification': instance.categoryNotification,
